...
const GrilleTarifaire = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-100 via-white to-blue-100 flex flex-col items-center py-10">
      ...
      <a href="/studio" className="mb-8 inline-block bg-yellow-400 hover:bg-yellow-500 text-black px-6 py-2 rounded-lg font-semibold shadow transition">← Retour au studio</a>
      ...
      <div className="flex flex-col items-center mt-6">
        ...
        <a
          ...
          download
          className="inline-block bg-blue-500 hover:bg-blue-600 text-white px-5 py-2 rounded-lg font-semibold shadow transition"
        >
